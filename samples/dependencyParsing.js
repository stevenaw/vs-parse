...
let projectData = parser.parseProject('./test/data/TestConsoleApplication/TestNUnit2/TestNUnit2.csproj');
...
projectData = parser.parseProject('./test/data/TestConsoleApplication/TestNUnit3/TestNUnit3.csproj');
...
let packages = parser.parsePackages('./test/data/TestConsoleApplication/TestNUnit3/packages.config');
...
let solution = parser.parseSolution('./test/data/TestConsoleApplication/TestConsoleApplication.sln', { deepParse: true });
